      ...
      <Grid container spacing={8}>
        ...
        <Grid item sm={3}>
          <Paper className="main-grid-item">
              <img
              src="images/TEAM_459_Logo.png"
              alt="Team 459 Logo"
              style={{ maxWidth: '250px', width: '100%', height: 'auto', marginBottom:'20px' }}
          /> 
            ...
            <Switch>
              ...
              />
              {
                this.state.loggedIn ? // Change to handle redirect by itself
                  <Route path="/users/:userId" render={ props => <UserDetail {...props} setLogout={this.setLogout} /> }/> 
                  :
